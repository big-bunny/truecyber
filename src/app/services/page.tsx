            ...
            <div key={index} className="mb-8">
              ...
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                {category.services.map((service, serviceIndex) => (
                  <Link href={`/service/${service.title}`} key={serviceIndex} legacyBehavior>
                    <a>
                      <div className="p-6 bg-white rounded-lg shadow-lg transform hover:scale-105">
                        ...
                        <button
                          className="py-2 px-4 bg-indigo-600 text-white rounded-md mt-4 hover:bg-indigo-800 animate-bounce"
                        >
                          Select
                        </button>
                      </div>
